# Privacy Policy for Workout Diary - Trainings plan - Fitness tracker

**Last Updated: January 6, 2026**

This Privacy Policy describes how Nicola Chiari ("we", "us", "our", or "Developer") collects, uses, and protects your personal information when you use the mobile application **Workout Diary - Trainings plan - Fitness tracker** (the "App").
...
**Data Controller & developer:** Nicola Chiari  
**Email of developer:** chiarinik96@gmail.com  
**Support Email:** geekstuio.dev@gmail.com  
**Location:** Italy (European Union)

For any privacy-related inquiries or to exercise your data rights, please contact us at the email addresses above.
...
- **Workout data** (exercises, sets, reps, weights, dates, notes)
- **Personal records** (max lifts, personal bests)
- **Body measurements** (weight, optional physical data you choose to log)

### 2.2 Information Collected Automatically
- **Device information** (device model, operating system version, unique device identifiers)
- **Usage data** (app features used, frequency of use, session duration)
- **Advertising ID** (used by Google AdMob for personalized advertising)
- **Crash and diagnostic data** (collected via Firebase Crashlytics to improve app stability)

### 2.3 Third-Party Services
The App integrates the following third-party services that may collect data according to their own privacy policies:

- **Google AdMob** - Advertising platform (collects Advertising ID, usage patterns)  
  Privacy Policy: https://policies.google.com/privacy

- **Google Play Billing** - In-app purchases (manages payment transactions; we do not have access to your credit card information)  
  Privacy Policy: https://payments.google.com/payments/apis-secure/get_legal_document?ldo=0&ldt=privacynotice

- **Firebase Authentication** - User authentication (stores encrypted email)  
  Privacy Policy: https://firebase.google.com/support/privacy

- **Firebase Realtime Database** - Cloud data storage (stores your workout logs and personal records)  
  Privacy Policy: https://firebase.google.com/support/privacy
...
- **To provide and maintain the App** - Sync your workout data across devices
- **To improve the App** - Analyze usage patterns and fix bugs
- **To provide customer support** - Respond to your inquiries and technical issues
- **To display advertisements** - Show relevant ads through Google AdMob
- **To process payments** - Handle in-app purchases through Google Play Billing
- **To ensure security** - Detect and prevent fraud or unauthorized access
- **To comply with legal obligations** - Respond to legal requests when required by law
...
- **Consent** - When you create an account and agree to sync your data (Article 6(1)(a) GDPR)
- **Contractual necessity** - To provide you with the App's features and services (Article 6(1)(b) GDPR)
- **Legitimate interests** - To improve the App, ensure security, and display advertising (Article 6(1)(f) GDPR)
...
We do not sell your personal information to third parties. However, under California law (CCPA), the use of advertising identifiers by AdMob may be considered "sharing" for cross-context behavioral advertising.

### 5.2 Service Providers
We share data with trusted third-party service providers (Firebase, Google AdMob, Google Play) who process data on our behalf to provide the App's functionality.

### 5.3 International Data Transfers
Your data may be transferred to and processed in countries outside the European Economic Area, including the United States, where Firebase and Google services are hosted. These transfers are protected by:
- **Standard Contractual Clauses (SCCs)** approved by the European Commission
- **Adequacy decisions** where applicable
- **Google's Data Processing Terms** and compliance frameworks

For more information, visit: https://policies.google.com/privacy/frameworks
...
- **Active accounts:** We retain your data for as long as your account is active or as needed to provide you with the App's services.
- **Inactive accounts:** If you do not use the App for 3 years, we may delete your data after notifying you via email.
- **Deleted accounts:** Upon account deletion request, all your personal data will be permanently deleted within **30 days**.
- **Legal obligations:** We may retain certain data for longer periods if required by law (e.g., financial records for tax purposes).

---

## 8. YOUR RIGHTS (GDPR & CCPA)

### 8.1 European Users (GDPR Rights)
...
To exercise these rights, contact us at chiarinik96@gmail.com. We will respond within **30 days**.

### 8.2 California Users (CCPA Rights)
If you are a California resident, you have the right to:

- **Know** what personal information we collect, use, and share
- **Request deletion** of your personal information
- **Opt-out of sale/sharing** - We do not "sell" data in the traditional sense, but AdMob's use of Advertising ID may qualify as "sharing." To opt out:
  - Go to **Android Settings > Google > Ads > Delete advertising ID** or **Opt out of Ads Personalization**
- **Non-discrimination** - We will not discriminate against you for exercising your privacy rights

To exercise these rights, contact us at chiarinik96@gmail.com or use our account deletion form (see Section 9).

---

## 9. ACCOUNT DELETION

To comply with Google Play requirements and user rights, you can request permanent deletion of your account and all associated data at any time.

**Account Deletion Request Form:**  
https://docs.google.com/forms/d/e/1FAIpQLSeFb9P0SdKvh1lyYmu-Ndy5kU1Afre2386goZBT_nFApcJ3ig/viewform?usp=dialog

Once submitted, all your data stored in Firebase (email, workout logs, personal records) will be permanently deleted within **30 days**. This action is irreversible.

Alternatively, you can email us at chiarinik96@gmail.com with the subject "Account Deletion Request."

---

## 10. CHILDREN'S PRIVACY

The App is not intended for use by individuals under the age of **16** (or the minimum age required in your jurisdiction). We do not knowingly collect personal information from children.

If you are a parent or guardian and believe your child has provided us with personal data, please contact us immediately at chiarinik96@gmail.com, and we will delete such information promptly.

---

## 11. COOKIES AND TRACKING TECHNOLOGIES

The App may use cookies and similar tracking technologies provided by third-party services (Firebase Analytics, AdMob) to:
...
**EU Representative (if applicable):** For GDPR-related inquiries, you may contact us at the email above.
...
**By using Workout Diary, you acknowledge that you have read and understood this Privacy Policy.**
